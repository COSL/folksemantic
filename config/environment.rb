...
Rails::Initializer.run do |config|
  ...
  config.gem 'muck-profiles', :lib => 'muck_profiles', :version => '>=0.2.1'
  ...
  config.gem 'muck-oauth', :lib => 'muck_oauth', :version => '>=0.1.5'
