...
Rails::Initializer.run do |config|
  ...
  config.gem "muck-services", :lib => 'muck_services', :version => '>=0.1.33'
  config.gem 'muck-users', :lib => 'muck_users', :version => '>=0.2.22'
  ...
  config.gem 'muck-contents', :lib => 'muck_contents', :version => '>=0.2.16'
