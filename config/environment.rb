...
Rails::Initializer.run do |config|
  ...
  config.gem "muck-services", :lib => 'muck_services', :version => '>=0.1.8'
  ...
  config.gem 'muck-profiles', :lib => 'muck_profiles', :version => '>=0.1.15'
  config.gem 'muck-friends', :lib => 'muck_friends', :version => '>=0.1.15'
