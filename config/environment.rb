...
Rails::Initializer.run do |config|
  ...
  config.gem "muck-raker", :lib => 'muck_raker', :version => '>=0.2.3'
  ...
  config.gem 'muck-profiles', :lib => 'muck_profiles', :version => '>=0.1.13'
  config.gem 'muck-friends', :lib => 'muck_friends', :version => '>=0.1.14'
  config.gem 'muck-shares', :lib => 'muck_shares', :version => '>=0.1.7'
  config.gem 'muck-contents', :lib => 'muck_contents', :version => '>=0.1.8'
